...
public class SampleAuto extends LinearOpMode {
    ...
    public static double turnToHeading2 = 270;
    public static double turnToHeading3 = 225;
    public static double turnToHeading4 = 270;
    public static double turnToHeading5 = 225;

    public static double lineToX1 = 48;
